...
from RGEsmathModule import DynkinIndex,SimplifyTraces,DeterminOrdering,Tr
##################################################################################
...
def CHbarlab(powe,comb,model):
	...
	res1 = 	Rational(1,2)*(
				model.Expand2(((_L,a,b,s1,s2),([[(_mf,p1,p2),(_Ya,s1,p2,p3),(_mf,p3,p4),(_Ya,s2,p4,p1)],
					[(_Y,s2,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p1)]])))#line 1
				)
...
def CHYabHbarYabH3ab(powe,comb,model):
	...
	resHY = (
			2*model.Expand2(
				(([[('Y2F',p1,p2),(_mfa,p2,p3),(_mf,p3,p4)],[(_mfa,p1,p2),(_mf,p2,p3),('Y2F',p3,p4)]]),([[(_Ya,a,p4,p5),(_Y,b,p5,p1)],[(_Ya,b,p4,p5),(_Y,a,p5,p1)]])))#Line 1 HY
	...
	resHYbar = 2*(model.Expand2(
		...
		(_mf,p3,p4),(_mfa,p4,p1)))#Line 1
			...
			+ model.Expand2(((_Y,s1,p1,p2),([[(_Ya,a,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5)],[(_mfa,p2,p3),(_Y,s1,p3,p4),(_Ya,a,p4,p5)]]),
				([[(_Y,b,p5,p6),(_mfa,p6,p1)],[(_mf,p5,p6),(_Ya,b,p6,p1)]])))#Line 3 and 4

			+ model.Expand2(((_Y,s1,p1,p2),([[(_Ya,b,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5)],[(_mfa,p2,p3),(_Y,s1,p3,p4),(_Ya,b,p4,p5)]]),
				([[(_Y,a,p5,p6),(_mfa,p6,p1)],[(_mf,p5,p6),(_Ya,a,p6,p1)]])))#Line 5 and 6
			)
	#resHYbarad = 2*(model.Expand2(
	#	((_mf,p1,p2),(_mfa,p2,p3),([[('Chain3Y',b,s1,a,p3,p4),(_Ya,s1,p4,p1)],[('Chain3Y',a,s1,b,p3,p4),(_Ya,s1,p4,p1)]])),dotrace=False)#Line 1

	#		+ model.Expand2((
	#			([[('Chain3Ya',s1,b,a,p1,p2)],[('Chain3Y',s1,a,b,p1,p2)]]),(_mf,p2,p3),(_Ya,s1,p3,p4),(_mf,p4,p1)),dotrace=False)#Line 2
	#		
	#		+ model.Expand2(((_Ya,s1,p1,p2),([[(_mf,p2,p3),(_Ya,b,p3,p4)],[(_Y,b,p2,p3),(_mfa,p3,p4)]]),([[(_mf,p4,p5),(_Ya,s1,p5,p6),(_Y,a,p6,p1)],[(_Y,a,p4,p5),(_Ya,s1,p5,p6),(_mf,p6,p1)]])),dotrace=False)#Line 3 and 4

	#		+ model.Expand2(((_Ya,s1,p1,p2),([[(_mf,p2,p3),(_Ya,a,p3,p4)],[(_Y,a,p2,p3),(_mfa,p3,p4)]]),([[(_mf,p4,p5),(_Ya,s1,p5,p6),(_Y,b,p6,p1)],[(_Y,b,p4,p5),(_Ya,s1,p5,p6),(_mf,p6,p1)]])),dotrace=False)#Line 5 and 6
	#		)
	resH3ab = 2*(model.Expand2((([[('Chain3Y',a,b,s1,p1,p2)],[('Chain3Y',b,a,s1,p1,p2)]]),
		(_mfa,p2,p3),(_mf,p3,p4),(_Ya,s1,p4,p1)))#Line 1

			+ model.Expand2(((_Ya,s1,p1,p2),(_mf,p2,p3),(_mfa,p3,p4),([[('Chain3Y',s1,a,b,p4,p1)],[('Chain3Y',s1,b,a,p4,p1)]])))#Line 2

			+ model.Expand2((([[(_Y,a,p1,p2),(_mfa,p2,p3)],[(_mf,p1,p2),(_Ya,a,p2,p3)]]),
				([[(_Y,s1,p3,p4),(_Ya,b,p4,p5),(_mf,p5,p6),(_Ya,s1,p6,p1)],[(_Y,s1,p3,p4),
			...
			+ model.Expand2((([[(_Y,b,p1,p2),(_mfa,p2,p3)],[(_mf,p1,p2),(_Ya,b,p2,p3)]]),
				([[(_Y,s1,p3,p4),(_Ya,a,p4,p5),(_mf,p5,p6),(_Ya,s1,p6,p1)],
					[(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,a,p5,p6),(_Ya,s1,p6,p1)]])))#Line 5
			)
...
#def CHYabHbarYabH3ab2(powe,comb,model):
#	"""Calculates HYab and HYbarab Eq 94 and 93 and 96."""
#	a,b = comb
#	#resHY = (2*model.Expand((('Y2F',p1,p2),(_mfa,p2,p3),(_mf,p3,p4),(_Ya,a,p4,p5),(_Y,b,p5,p1)),dotrace=False)#Line 1 HY
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_mfa,p2,p3),(_mf,p3,p4),(_Ya,b,p4,p5),(_Y,a,p5,p1)),dotrace=False)#Line 1
#	#		+ 2*model.Expand(((_mfa,p1,p2),(_mf,p2,p3),('Y2F',p3,p4),(_Ya,a,p4,p5),(_Y,b,p5,p1)),dotrace=False)#Line 1
#	#		+ 2*model.Expand(((_mfa,p1,p2),(_mf,p2,p3),('Y2F',p3,p4),(_Ya,b,p4,p5),(_Y,a,p5,p1)),dotrace=False)#Line 1
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_Ya,a,p2,p3),(_mf,p3,p4),(_Ya,b,p4,p5),(_mf,p5,p1)),dotrace=False)#Line 2
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_Ya,a,p2,p3),(_mf,p3,p4),(_mfa,p4,p5),(_Y,b,p5,p1)),dotrace=False)#Line 2
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_mfa,p2,p3),(_Y,a,p3,p4),(_Ya,b,p4,p5),(_mf,p5,p1)),dotrace=False)#Line 3
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_mfa,p2,p3),(_Y,a,p3,p4),(_mfa,p4,p5),(_Y,b,p5,p1)),dotrace=False)#Line 3
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_Ya,b,p2,p3),(_mf,p3,p4),(_Ya,a,p4,p5),(_mf,p5,p1)),dotrace=False)#Line 4
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_Ya,b,p2,p3),(_mf,p3,p4),(_mfa,p4,p5),(_Y,a,p5,p1)),dotrace=False)#Line 4
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_mfa,p2,p3),(_Y,b,p3,p4),(_Ya,a,p4,p5),(_mf,p5,p1)),dotrace=False)#Line 5
#	#		+ 2*model.Expand((('Y2F',p1,p2),(_mfa,p2,p3),(_Y,b,p3,p4),(_mfa,p4,p5),(_Y,a,p5,p1)),dotrace=False)#Line 5
#	#			)
#	resHYbar = 2*(#model.Expand(((_Y,s1,p1,p2),('Chain3Ya',a,s1,b,p2,p3),(_mf,p3,p4),(_mfa,p4,p1)),dotrace=False)#Line 1
#			#+ model.Expand(((_Y,s1,p1,p2),('Chain3Ya',b,s1,a,p2,p3),(_mf,p3,p4),(_mfa,p4,p1)),dotrace=False)#Line 1
#			#+ model.Expand(((_mfa,p1,p2),(_Y,s1,p2,p3),(_mfa,p3,p4),('Chain3Y',a,b,s1,p4,p1)),dotrace=False)#Line 2
#			#+ model.Expand(((_mfa,p1,p2),(_Y,s1,p2,p3),(_mfa,p3,p4),('Chain3Y',b,a,s1,p4,p1)),dotrace=False)#Line 2
#			#+ model.Expand(((_Y,s1,p1,p2),(_Ya,a,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,b,p5,p6),(_mfa,p6,p1)),dotrace=False)#Line 3
#			#+ model.Expand((('Chain3Ya',b,s1,a,p1,p2),(_Y,s1,p2,p3),(_mfa,p3,p4),(_mf,p4,p1)),dotrace=False)#Line 3
#			#+ model.Expand(((_Y,s1,p1,p2),(_mfa,p2,p3),('Chain3Y',s1,a,b,p3,p4),(_mfa,p4,p1)),dotrace=False)#Line 4
#			#+ model.Expand(((_Y,s1,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_Ya,a,p4,p5),(_mf,p5,p6),(_Ya,b,p6,p1)),dotrace=False)#Line 4
#			+ model.Expand(((_Y,s1,p1,p2),(_Ya,b,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,a,p5,p6),(_mfa,p6,p1)),dotrace=False)#Line 5
#			+ model.Expand((('Chain3Ya',a,s1,b,p1,p2),(_Y,s1,p2,p3),(_mfa,p3,p4),(_mf,p4,p1)),dotrace=False)#Line 5
#			+ model.Expand(((_Y,s1,p1,p2),(_mfa,p2,p3),('Chain3Y',s1,b,a,p3,p4),(_mfa,p4,p1)),dotrace=False)#Line 6
#			+ model.Expand(((_Y,s1,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_Ya,b,p4,p5),(_mf,p5,p6),(_Ya,a,p6,p1)),dotrace=False)#Line 6
#			)
##	resH3ab = 2*(model.Expand((('Chain3Y',a,b,s1,p1,p2),(_mfa,p2,p3),(_mf,p3,p4),(_Ya,s1,p4,p1)),dotrace=False)#Line 1
##			+ model.Expand((('Chain3Y',b,a,s1,p1,p2),(_mfa,p2,p3),(_mf,p3,p4),(_Ya,s1,p4,p1)),dotrace=False)#Line 1
##			+ model.Expand(((_mf,p1,p2),(_mfa,p2,p3),('Chain3Y',s1,a,b,p3,p4),(_Ya,s1,p4,p1)),dotrace=False)#Line 2
##			+ model.Expand(((_mf,p1,p2),(_mfa,p2,p3),('Chain3Y',s1,b,a,p3,p4),(_Ya,s1,p4,p1)),dotrace=False)#Line 2
##			+ model.Expand(((_Y,a,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_Ya,b,p4,p5),(_mf,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 3
##			+ model.Expand(((_Y,a,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,b,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 3
##			+ model.Expand(((_mf,p1,p2),(_Ya,a,p2,p3),(_Y,s1,p3,p4),(_Ya,b,p4,p5),(_mf,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 4
##			+ model.Expand(((_mf,p1,p2),(_Ya,a,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,b,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 4
##			+ model.Expand(((_Y,b,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_Ya,a,p4,p5),(_mf,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 5
##			+ model.Expand(((_Y,b,p1,p2),(_mfa,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,a,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 5
##			+ model.Expand(((_mf,p1,p2),(_Ya,b,p2,p3),(_Y,s1,p3,p4),(_Ya,a,p4,p5),(_mf,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 6
##			+ model.Expand(((_mf,p1,p2),(_Ya,b,p2,p3),(_Y,s1,p3,p4),(_mfa,p4,p5),(_Y,a,p5,p6),(_Ya,s1,p6,p1)),dotrace=False)#Line 6
##			)
##	resHY = resHY.doit() if resHY != 0 else resHY
#	resHYbar = resHYbar.doit() if resHYbar != 0 else resHYbar
#	#resH3ab = resH3ab.doit() if resH3ab != 0 else resH3ab
#	resHYbarad = resHYbar.adjoint() if resHYbar != 0 else 0 
#	resHYbarad = resHYbarad.doit() if resHYbarad != 0 else resHYbarad
#	#resFinal = SimplifyTraces(Tr(resHY)  + Tr(resHYbar) + Tr(resHYbarad) + Tr(resH3ab),model)
#	powe[0] = powe[0].subs(HYab,resFinal).subs(HbarYab,0).subs(H3ab,0)
#	return powe[0]
...
def CL2gab(powe,comb,model):
	...
	a,b = comb
	res = (model.Expand(((_G,gg1),(_L,a,b,s1,s2),(_ms,s3,s4),(_Th,gg1,s1,s3),(_Th,gg1,s2,s4)),MatStruc=['a','a'])
			+ model.Expand(((_G,gg1),(_h,a,s1,s2),(_h,b,s3,s4),(_Th,gg1,s1,s3),(_Th,gg1,s2,s4)),MatStruc=['a','a'])
			)
...
def CHFab(powe,comb,model):
	...
	a,b = comb
	res = 2*(
			model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_Y,a,p1,p2)],[(_Y,a,p1,p2),(_C,gg1,p2)]]),(_Ya,b,p2,p3),(_mf,p3,p4),(_mfa,p4,p1)))#Line 1

		+ model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_Y,b,p1,p2)],[(_Y,b,p1,p2),(_C,gg1,p2)]]),(_Ya,a,p2,p3),(_mf,p3,p4),(_mfa,p4,p1)))#Line 2
		
		+ model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_mf,p1,p2)],[(_mf,p1,p2),(_C,gg1,p2)]]),
			(_mfa,p2,p3),([[(_Y,a,p3,p4),(_Ya,b,p4,p1)],[(_Y,b,p3,p4),(_Ya,a,p4,p1)]])))#Line 3

		+ model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_Y,a,p1,p2)],[(_Y,a,p1,p2),(_C,gg1,p2)]]),
			(_mfa,p2,p3),([[(_Y,b,p3,p4),(_mfa,p4,p1)],[(_mf,p3,p4),(_Ya,b,p4,p1)]])))#Line 4

		+ model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_mf,p1,p2)],[(_mf,p1,p2),(_C,gg1,p2)]]),(_Ya,a,p2,p3),
			([[(_Y,b,p3,p4),(_mfa,p4,p1)],[(_mf,p3,p4),(_Ya,b,p4,p1)]])))#Line 5

		+ model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_Y,b,p1,p2)],[(_Y,b,p1,p2),(_C,gg1,p2)]]),
			(_mfa,p2,p3),([[(_Y,a,p3,p4),(_mfa,p4,p1)],[(_mf,p3,p4),(_Ya,a,p4,p1)]])))#Line 6

		+ model.Expand2(((_G,gg1),([[(_C,gg1,p1),(_mf,p1,p2)],[(_mf,p1,p2),(_C,gg1,p2)]]),
			(_Ya,b,p2,p3),([[(_Y,a,p3,p4),(_mfa,p4,p1)],[(_mf,p3,p4),(_Ya,a,p4,p1)]])))#Line 7
		)
...
def CBYabBbarYab(powe,comb,model):
	...
	a,b = comb
	resBY = (
	model.Expand(((_G,gg1),(_G,gg2),(_Th,gg1,a,s1),(_Th,gg2,s1,b),(_Ta,gg3,p1,p2),(_Ta,gg4,p2,p3),(_mf,p3,p4),(_mfa,p4,p1)),MatStruc=[['a','b','a','b'],['b','a','a','b']])
 + model.Expand(((_G,gg1),(_G,gg2),(_Th,gg1,a,s1),(_Th,gg2,s1,b),(_mf,p1,p2),(_T,gg3,p2,p3),(_T,gg4,p3,p4),(_mfa,p4,p1)),MatStruc=[['a','b','a','b'],['b','a','a','b']])
 )
	resBYbar = -10*( 
	model.Expand(((_G,gg1),(_G,gg2),(_Th,gg1,a,s1),(_Th,gg2,s1,b),(_Ta,gg3,p1,p2),(_mf,p2,p3),(_Ta,gg4,p3,p4),(_mfa,p4,p1)),MatStruc=[['a','b','a','b'],['b','a','a','b']])
 )
