...
def set_globalsFM(model):
    """copy the globals from RGEsModule into the local gloabls()"""
...
def CYukFermionMassII(powe, comb, model):
    ...
    res = (
        2 * (
            ...
            - model.Expand(((_Y, s1, f1, p1), (_Ya, s2, p1, p2), (_mf, p2, p3), (_Ya, s2, p3, p4), (_Y, s1, p4, f2)),
                           dotrace=False)  # Line 1
        )
        - model.Expand2(((_Y, s1, f1, p1), ([[('Y2F', p1, p2), (_mfa, p2, p3)], [(_mfa, p1, p2), ('Y2Fa', p2, p3)]]),
                         (_Y, s1, p3, f2)), dotrace=False)  # Line 2

        - Rational(1, 8) * (
            model.Expand2((([[(_Y, s1, f1, p1), ('Y2F', p1, p2), (_Ya, s1, p2, p3), (_mf, p3, f2)],
                             [(_mf, f1, p1), (_Ya, s1, p1, p2), ('Y2Fa', p2, p3), (_Y, s1, p3, f2)]])), dotrace=False)
			# Line 3
        )
        - 2 * kappa * (
        model.Expand2(((_Y, s1, f1, p1), (_Ya, s2, p1, p2), (_Y, s1, p2, f2), ([[(_mfa, p3, p4), (_Y, s2, p4, p3)],
                                                                                [(_mf, p3, p4), (_Ya, s2, p4, p3)]])))
			# Line 4
        )
        - Rational(3, 2) * kappa * (
        ...
        model.Expand2(((_Y, s1, f1, f2), ([[(_Y, s2, p1, p2), (_mfa, p2, p3), (_Y, s2, p3, p4), (_Ya, s1, p4, p1)],
                                           [(_Ya, s2, p1, p2), (_mf, p2, p3), (_Ya, s2, p3, p4), (_Y, s1, p4, p1)]])))
			# Line 7
        )
