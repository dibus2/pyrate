...
def CYukGaugeIIg2(powe, comb, model):
    ...
    res = (
        ...
        + 6 * (model.Expand(((_G, gg1), (_Cs, gg1, s1), (_Y, s1, f1, p1), (_Ya, sc, p1, p2), (_Y, s1, p2, f2)),
               ...
               - 2 * model.Expand(((_G, gg1), (_Cs, gg1, sc), (_Y, s1, f1, p1), (_Ya, sc, p1, p2), (_Y, s1, p2, f2)),
                                  dotrace=False)  # Line 11
               )
        + Rational(9, 2) * (
...
def CYukGaugeIIg4(powe, comb, model):
    ...
    res = (
        ...
        + Rational(11, 12) * (model.Expand2(((_G, gg1), (_G, gg1), (_Ss, gg1),
                                             ([[(_C, gg1, f1), (_Y, sc, f1, f2)], [(_Y, sc, f1, f2), (_C, gg1, f2)]])),
                                            dotrace=False)  # Line 15
                              )
        - Rational(21, 2) * (model.Expand(((_G, gg1), (_G, gg2), (_Cs, gg1, sc), (_Cs, gg2, sc), (_Y, sc, f1, f2)),
                                          dotrace=False))  # Line 15
