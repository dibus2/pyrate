...
subExpandRGEs = {trace[a__]:>Tr[Dot[a]], ScalarProd->Dot, MatMul->MatM, Adj[x_]:>TransposeCheck[Conjugate[x]], Tp[x_]:>TransposeCheck[x], conj->Conjugate};
...
temp=Log[10] *((AllRGEs[[i,2]] /. subParameters//. subExpandRGEs //. sub )/.Tr[x__]->(x)/.Dot->Times);
